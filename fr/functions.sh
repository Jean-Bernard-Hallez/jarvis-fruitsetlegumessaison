...
say "Voici les fruits de saison du mois de $onest_saison_now: $ligne_num_fruitslegumes"
}
...
say "Voici les légumes de saison du mois de $onest_saison_now: $ligne_num_fruitslegumes"
}
